...
async def get_clusters(
    ...
    """
    return await get_theme_clusters_from_db(db=db, start_date=start_date, end_date=end_date)
...
async def get_trends(
    ...
    """
    return await get_theme_trends_from_db(db=db, time_window_days=time_window_days)
